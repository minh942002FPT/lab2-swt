...
public class DetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String notid = request.getParameter("pid");
            DAO dao = new DAO();
            ...
            ArrayList<Product> listExceptDetailProduct = dao.getNotProductByProductID(notid);
            ArrayList<Category> listCategory = dao.getAllCategory();
            
            request.setAttribute("activePage", "detail");
            request.setAttribute("shopdetail", true);
            
            request.setAttribute("p", p);
            request.setAttribute("listExceptDetailProduct", listExceptDetailProduct);
